...
const Page: NextPageWithLayout = () => {
  const features = [
    ...
    },
    {
      name: "Honeymoon Fund",
      description:
        "Please help us celebrate our marriage with a gift to our honeymoon fund. We are planning to take our honeymoon throughout Japan for two weeks following the wedding.",
      ...
      <div className="font-display py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="sm:text-center">
            <h2 className="text-lg font-semibold leading-8 uppercase text-green-primary">
              Registry
            </h2>
            <p className="mt-2 text-3xl font-bold tracking-widest text-green-dark sm:text-4xl uppercase">
              Registered Websites & Wedding Funds
            </p>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600">
              If you would like to gift Sabrina & Owen something, please
              consider using one of the several options below. Gifts are not
              required, but are greatly appreciated. Thank you!
            </p>
          </div>
              ...
              {features.map((feature) => (
                ...
                >
                  <div className="sm:min-w-0 sm:flex-1">
                    <p className="text-2xl font-semibold leading-8 text-green-dark uppercase">
                      {feature.name}
                    </p>
