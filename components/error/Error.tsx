    ...
    <div className="min-h-full bg-white px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8 font-display">
        <div className="mx-auto max-w-max">
          <main className="sm:flex">
            <p className="text-4xl font-bold tracking-tight text-green-dark sm:text-5xl">{statusCode}</p>
            <div className="sm:ml-6">
              <div className="sm:border-l sm:border-gray-200 sm:pl-6">
                <h1 className="text-4xl font-bold tracking-tight text-green-primary sm:text-5xl uppercase mb-4">Page not found</h1>
                <p className="mt-1 text-base text-green-primary">Please check the URL in the address bar and try again.</p>
                <p className="mt-1 text-base text-green-primary">If you are still experiencing issues please contact <span className='text-green-dark underline'><a href="mailto:rothowen27@gmail.com">rothowen27@gmail.com</a></span></p>
              </div>
